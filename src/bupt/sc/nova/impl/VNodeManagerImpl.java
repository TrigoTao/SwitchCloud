...
public class VNodeManagerImpl implements VNodeManager {
	...
	@Override
	public int addVNode(String nodeType, int subnetId) {
		...
		if(null != subnetInfo){
			...
			String targetEendPoint = "http://10.108.119.165:8081/axis/services/IVirtualNetManager";
			...
			try {
				...
				vNodeInfo.setCreateTime(new Date(vnodeInIaaS.getCreateTime())); 
